      ...
      <SafeAreaView style={styles.forgotPasswordComp}>
        <View style={styles.forgotPasswordBx}>
          ...
          <Text style={styles.forgotpoasswrdText}>
            Please enter your WhatsApp no. to reset your password.
          </Text>
        </View>
        <Formik
          initialValues={{
          ...
          {({
            ...
            <View style={styles.forgotpasswordform}>
              <View style={styles.InputBx}>
                ...
                <FormError error={errors} touched={touched} name={"phoneNumber"} />
              </View>
              <Text
        ...
        <Text style={styles.remebEmil}>
          Don't remember your Registerd WhatsApp no.?{" "}
        </Text>
