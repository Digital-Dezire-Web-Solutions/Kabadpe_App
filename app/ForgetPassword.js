        ...
        <>
            <SafeAreaView style={styles.forgotPasswordComp}>
                <View style={styles.forgotPasswordBx}>
                    ...
                    <Text style={styles.forgotpoasswrdText}>Please enter your email address to reset your password.</Text>
                </View>

                <View style={styles.forgotpasswordform}>

                    <View style={styles.InputBx}>
                        <Text style={styles.label}>Whatsapp No. / Mobile No. / Emai Id  </Text>
                        <View style={styles.input}>
                            <Feather style={styles.icon} name="mail" size={15} color="#a6a4a4" />
                            <TextInput style={styles.mainInput} value={email} onChangeText={(text) => setEmail(text)} placeholder="Enter your whatsapp no. or email id..." />

                        </View>
                    </View>

                    <TouchableOpacity onPress={() => handleModal()} activeOpacity={0.7} style={[styles.signInBtn, styles.forgotpasswrdBtn, { backgroundColor: bgColor }]}
          ...
          <View style={styles.workerareabx}>
            ...
            <ReactNativeModal isVisible={otp} animationIn={'bounceInUp'} animationInTiming={800} style={{ justifyContent: 'flex-end', margin: 0 }}
            ...
            >
                <View style={styles.otpModalBx}>
                    ...
                    <View style={styles.otpImg}>
                        <Image style={styles.otpicon} source={require('../assets/images/password-access.png')} />
                    </View>

                    <View style={styles.otptextBx}>
                        <Text style={styles.otptext}>Enter OTP</Text>
                        <Text style={styles.sixdigittext}>An 6 digit code has been sent to +91 9971464759</Text>
                    </View>
                    ...
                    <View style={styles.otpverifyBtn}>
                        <TouchableOpacity activeOpacity={0.7} style={[styles.signInBtn, styles.forgotpasswrdBtn, { backgroundColor: bgColor }, styles.verifyBtn]}
                            onPressIn={() => setBgColor('#046e7a')} // Change to darker color when pressed
                            onPressOut={() => setBgColor('#026874')}
                        >
