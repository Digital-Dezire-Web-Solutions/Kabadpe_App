...
const BuyWaste = () => {
    ...
    const amount =  parseFloat(weight) * parseFloat(selectProd.bulkPrice) ;
            ...
            <SafeAreaProvider>
                <ScrollView style={styles.buyWasteComp} nestedScrollEnabled={true}>
                    ...
                    <View style={styles.productChooseandweightBx}>
                        ...
                        <TouchableOpacity onPress={() => setShowBx(!showBx)} activeOpacity={0.76} style={[styles.chooseProdBx]}>
...
{/* 
                    ...
                    {showBx && <View style={styles.chooseProductMain}>

                        <ScrollView style={styles.chooseProdListBx} nestedScrollEnabled={true}>
                            {products.map((item, id) => (
                                <TouchableOpacity onPress={() => handleSelectBx(item)} activeOpacity={0.76} key={id} style={[styles.prodliBx, { backgroundColor: selectProd?.name === item.name ? "#eee" : "#fff" }]} >
                                    <View style={styles.ProdIconBx}>
                                        <Image style={{ width: 20, height: 20, objectFit: 'cover' }} source={item.icon} />
                                    </View>
                        ...
                        {cart.map((curElem,id) => (
                            <View style={styles.cartitemBx} key={id}>
                                <View style={styles.cartProdBx}>
                                    <Text style={styles.cartProdText}> {curElem.name} </Text>
                                    <View style={styles.cartProdImgbx}>
                                        <Image style={{width : 20, height : 20, objectFit:'cover'}} source={curElem.icon}  />
                                        </View>
                                    ...
                                    <View  style={styles.prodotherinfobx}> 
                                            <View style={styles.prodotherinfo}>
                                                ...
                                                <Text style={styles.prodrelText2}>
                                                Retail Price/Kg
                                                </Text>
                                                </View>
                    ...
                    <View style={styles.addmorebx}>
                        <Text style={{fontSize : 15, fontWeight : '500' , color : "#026874"}}>Add More</Text>
                    </View>
                    </View>
            ...
            <View>
                ...
                <ReactNativeModal isVisible={walletModal} animationIn={"fadeIn"}
                ...
                >
                    ...
                    <View style={styles.apntCancelPopup}>
                        ...
                        <Text style={[styles.cancelApntText, { fontWeight: '600', fontSize: 15, }]}>Payment has been made </Text>

                        <Text style={styles.cancelApntText}>₹970.00 has been sent to  “User’s Name”  </Text>
                ...
                <ReactNativeModal isVisible={cashPaidModal} animationIn={"fadeIn"}
                ...
                >
                    ...
                    <View style={styles.apntCancelPopup}>
                        ...
                        <Text style={styles.cancelApntText}>₹970.00 paid to  “User’s Name” in cash </Text>
                ...
                {/* Error Popup (modal) */}
                <ReactNativeModal isVisible={errorModal} animationIn={"fadeIn"}
                    onBackButtonPress={() => setCashPaidModal(false)}
                    onBackdropPress={() => setCashPaidModal(false)}
                >
                    ...
                    <View style={styles.apntCancelPopup}>
                        ...
                        <Text style={[styles.cancelApntText, { fontWeight: '600', fontSize: 15, }]}>Insufficient fund </Text>

                        <Text style={styles.cancelApntText}>Please check you wallet Balance,
                            it seems you have insufficient fund to pay </Text>
                ...
                <ReactNativeModal isVisible={weightModal} animationIn={"fadeIn"}
                ...
                >
                    ...
                    <View style={styles.WeightPopup}>
                                ...
                                <Text style={styles.prodText}>Product : <Text style={{fontWeight : '500'}}> {selectProd?.name} </Text></Text>

                                <View style={styles.prodInfoList}>
                                    <Text style={{fontSize: 13, color : "#323232"}}>Retails Price/Kg: </Text>
                                    <Text style={{fontWeight : '500', color : "#242421"}}>₹15.00</Text>
                                </View>
                                <View style={styles.prodInfoList}>
                                    <Text style={{fontSize: 13, color : "#323232"}}>Bulk Price/Kg: </Text>
                                    <Text style={{fontWeight : '500', color : "#242421"}}>₹12.00</Text>
                                </View>
                             
                             <View style={styles.weightInptBx}>
                                <Text style={styles.weightlabel}>Weight (kg)</Text>
                                <View style={styles.weightInpt}>
                                    <TextInput style={styles.textinputbx} placeholder='Enter Product weight' placeholderTextColor={"#7c7c7c"}  keyboardType='numeric' value={weight} onChangeText={(text) => setWeight(text)} />
                                        <TouchableOpacity onPress={handleCart} activeOpacity={0.676} style={styles.cartBtn}>
            ...
            <View style={styles.bottom_paywallet_cashPaid_amnt_bx}>
                ...
                <TouchableOpacity onPress={() => setWalletModal(true)} style={styles.paywaletBtn}>
                    <Text style={styles.waletText}>Pay to Wallet</Text>
                </TouchableOpacity>

                <TouchableOpacity onPress={() => setCashPaidModal(true)} style={styles.paywaletBtn}>
                ...
                <View style={styles.totalAmnt_bx}>
                    ...
                    <Text style={styles.amntNumber}>970.00</Text>
                </View>
