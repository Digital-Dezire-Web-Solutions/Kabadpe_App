import { Button, Dimensions, FlatList, Image, ScrollView, StyleSheet, Text, Touchable, TouchableHighlight, TouchableOpacity, View } from 'react-native'
...
const Dashboard = () => {
    ...
    return (
        <>
            <SafeAreaProvider>
                <ScrollView scrollEnabled={menuOpen} style={styles.dashboardScreen} nestedScrollEnabled={true}>
