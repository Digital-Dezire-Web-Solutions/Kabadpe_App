...
const AddressChooseModal = ({modal , setModal}) => {
    const router  =  useRouter();
  return (
   <>
   <ReactNativeModal isVisible={modal} animationIn="fadeInUp" style={{justifyContent : 'flex-end' , margin : 0, }}
            ...
            >
                ...
                <View style={styles.ChooseAddressBx}> 
                    ...
                    <TouchableOpacity onPress={() => setModal(false)}  style={[styles.addrssBtnBx , styles.addrssBtnBx2]}>
                ...
                <MaterialIcons name="edit" size={18} style={styles.arrowRight} color="#03acc0" />
              ...
              <TouchableOpacity onPress={() => setModal(false)}   style={[styles.addrssBtnBx , styles.addrssBtnBx2 ]}>
                ...
                <MaterialIcons name="edit" size={18} style={styles.arrowRight} color="#03acc0" />
                    ...
                    <TouchableOpacity style={[styles.saveBtn , styles.saveBtn2] } 
                    onPress={() => {router.navigate("MapScreen") , setModal(false)}}>
